...
const Form: FC<SectionProps> = ({ data, settings, themeSettings }) => {
  ...
  const inputClasses = isDark
    ...
    : 'w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-slate-900 placeholder-gray-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500';
