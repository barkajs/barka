    ...
    <Base {...props}>
          ...
          <div class="mx-auto max-w-7xl px-6">
            <div class="mb-16 max-w-2xl">
              <h2 class="reveal-heading text-3xl font-bold tracking-[-0.03em] sm:text-4xl lg:text-5xl">
                The challenges <em class="not-italic" style={{ background: `linear-gradient(135deg,${token.primary},${alpha(token.primary, 60)},${token.accent})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>we solve</em>
              </h2>
            ...
            <div class="grid gap-16 lg:grid-cols-5">
              ...
              <div class="lg:col-span-2">
                <div class="lg:sticky lg:top-32">
                  <h2 class="reveal-heading text-3xl font-bold tracking-[-0.03em] sm:text-4xl">Our proven <em class="not-italic" style={{ background: `linear-gradient(135deg,${token.primary},${alpha(token.primary, 60)},${token.accent})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>approach</em></h2>
      ...
      {fields.capabilities && Array.isArray(fields.capabilities) && fields.capabilities.length > 0 && (
        <section class="relative overflow-hidden py-24">
          <div class="mx-auto max-w-7xl px-6">
            <div class="mb-16 max-w-2xl">
              <h2 class="reveal-heading text-3xl font-bold tracking-[-0.03em] sm:text-4xl">What we <em class="not-italic" style={{ background: `linear-gradient(135deg,${token.primary},${alpha(token.primary, 60)},${token.accent})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>deliver</em></h2>
            </div>
        ...
        <section class="relative overflow-hidden border-t border-gray-100 bg-slate-50 py-24">
          <div class="mx-auto max-w-7xl px-6">
            <div class="grid items-start gap-12 lg:grid-cols-5">
              <div class="lg:col-span-2">
                <h2 class="reveal-heading text-3xl font-bold tracking-[-0.03em] sm:text-4xl">Recruitment <em class="not-italic" style={{ background: `linear-gradient(135deg,${token.primary},${alpha(token.primary, 60)},${token.accent})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>tools</em></h2>
        ...
        <section class="py-24">
          <div class="mx-auto max-w-7xl px-6">
            <div class="mb-16 flex items-end justify-between">
              <div class="max-w-2xl">
                <h2 class="reveal-heading text-3xl font-bold tracking-[-0.03em] sm:text-4xl">Proven <em class="not-italic" style={{ background: `linear-gradient(135deg,${token.primary},${alpha(token.primary, 60)},${token.accent})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>results</em></h2>
