        ...
        <div class="relative mx-auto max-w-7xl px-6">
          ...
          <div class="reveal-sub mt-12 flex flex-wrap gap-12" style={{ animationDelay: '0.4s' }}>
            ...
            <div>
              ...
              <div class="mt-1 text-xs uppercase tracking-widest text-gray-400">Placements Per Year</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {featured && (
        <section class="py-20">
          <div class="mx-auto max-w-7xl px-6">
            <p class="reveal-sub mb-8 text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">Featured Success Story</p>
            <a
          ...
          <div class="grid items-center gap-10 lg:grid-cols-5">
            <div class="lg:col-span-3">
              <h2 class="reveal-heading text-3xl font-bold tracking-[-0.03em] sm:text-4xl">
                Have a similar hiring challenge?
              </h2>
