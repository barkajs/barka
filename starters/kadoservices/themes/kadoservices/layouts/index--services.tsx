      ...
      <section class="relative overflow-hidden py-28 text-white" style={{ backgroundColor: token.navy }}>
        ...
        <div class="relative mx-auto max-w-7xl px-6">
          ...
          <h1 class="reveal-heading max-w-4xl text-4xl font-extrabold tracking-[-0.04em] leading-[1.05] sm:text-5xl lg:text-6xl">
            End-to-end{' '}
            <em class="not-italic" style={{ background: `linear-gradient(135deg, ${token.primary}, ${token.accent})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>staffing</em>{' '}
            solutions
          </h1>
          ...
          <div class="mx-auto max-w-7xl px-6">
            <div class="mb-14 max-w-2xl">
              ...
              <h2 class="text-3xl font-bold tracking-[-0.03em] text-slate-900">
                Every staffing solution you need, <em class="not-italic" style={{ color: token.primary }}>under one roof</em>
              </h2>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-6">
          <div class="mb-16 text-center">
            ...
            <h2 class="text-3xl font-bold tracking-[-0.03em] text-slate-900 sm:text-4xl">
              From first call to <em class="not-italic" style={{ color: token.primary }}>placement</em>
            </h2>
          ...
          <div class="grid items-center gap-12 lg:grid-cols-5">
            <div class="lg:col-span-3">
              ...
              <h2 class="reveal-heading text-3xl font-bold tracking-[-0.03em] sm:text-4xl lg:text-5xl">
                Ready to{' '}
                <em class="not-italic" style={{ background: `linear-gradient(135deg, ${token.primary}, ${token.accent})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>build</em>{' '}
                your team?
              </h2>
