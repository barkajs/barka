      ...
      <section class="relative overflow-hidden py-28 text-white" style={{ backgroundColor: navColor }}>
        ...
        <div class="relative mx-auto max-w-7xl px-6">
          ...
          <p class="reveal-sub mt-6 max-w-2xl text-lg leading-relaxed text-gray-300/80" style={{ animationDelay: '0.3s' }}>
            From strategy to production — one partner for your entire technology stack. 800+ engineers, 200+ projects, 15+ years of enterprise delivery.
          </p>
          <div class="reveal-sub mt-14 flex flex-wrap gap-12" style={{ animationDelay: '0.45s' }}>
            ...
            <div>
              <div class="text-3xl font-extrabold">800+</div>
      ...
      <section class="py-24">
        <div class="mx-auto max-w-7xl px-6">
          ...
          <div class="grid gap-px overflow-hidden rounded-2xl border border-gray-100 bg-gray-100 md:grid-cols-2 lg:grid-cols-4">
            {[
              { step: '01', title: 'Discovery', desc: 'Deep-dive workshops to understand your business, map challenges, and define success metrics.' },
              { step: '02', title: 'Architecture', desc: 'Solution design reviewed by certified architects. Technology choices justified by your constraints.' },
              { step: '03', title: 'Delivery', desc: 'Agile sprints with continuous demos. Working software every two weeks. Zero surprises.' },
