    ...
    <Base {...props}>
      ...
      <section class="relative overflow-hidden py-28 text-white" style={{ backgroundColor: token.navy }}>
        ...
        <div class="relative mx-auto max-w-7xl px-6">
          <div class="max-w-3xl">
            <p class="reveal-sub mb-4 text-xs font-semibold uppercase tracking-[0.25em] text-gray-400">Our Services</p>
            ...
            <div class="grid items-start gap-12 lg:grid-cols-5">
              ...
              <div class="flex flex-wrap gap-3 lg:col-span-3">
                {fields.technologies.map((tech: { name: string; logo?: string }, idx: number) => (
                  <div
                    class="stagger-grid flex items-center gap-2.5 rounded-xl border border-gray-100 bg-white px-5 py-3.5 transition-all duration-300 hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-500/5"
        ...
        <div class="relative mx-auto max-w-7xl px-6">
          <div class="grid items-center gap-10 lg:grid-cols-5">
            <div class="lg:col-span-3">
              <h2 class="reveal-heading text-3xl font-bold tracking-[-0.03em] sm:text-4xl">Ready to start your project?</h2>
              <p class="reveal-sub mt-4 max-w-lg text-lg text-gray-300/90" style={{ animationDelay: '0.2s' }}>
                Get a free consultation. Our architects and domain experts will map the optimal strategy for your challenge in a 60-minute workshop.
              </p>
            </div>
